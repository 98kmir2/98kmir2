...
uses
  ...
  Awesomium, AnimSprite, ShellAPI, HotKey;
...
{$ENDIF}
  ...
  public
    ...
    procedure SetImgIndex(Lib: TObject; Index: Integer); overload;
    procedure SetImgIndex(Lib: TObject; Index, X, Y: Integer); overload;

    procedure SetImgName(Lib: TObject; F: string); overload;
    procedure SetImgName(Lib: TObject; F: string; X, Y: Integer); overload;

    property WLib: TObject read FWLib write FWLib;
    property ULib: TObject read FULib write FULib;
  published
...
procedure THGEControl.SetImgIndex(Lib: TObject; Index, X, Y: Integer);
var
  Tex                       : ITexture;
{$IF CUSTOMUI_SAVE}
  sFileName                 : string;
...
procedure THGEControl.SetImgIndex(Lib: TObject; Index: Integer);
var
  Tex                       : ITexture;
{$IF CUSTOMUI_SAVE}
  sFileName                 : string;
...
procedure THGEControl.SetImgName(Lib: TObject; F: string);
var
  Tex                       : ITexture;
begin
  try
...
procedure THGEControl.SetImgName(Lib: TObject; F: string; X, Y: Integer);
var
  Tex                       : ITexture;
begin
  try
