...
type
  ...
  IDirect3DDevice8 = interface (IUnknown)
    ...
    function GetAvailableTextureMem : Cardinal; stdcall;     //+10
    ...
    function GetDisplayMode(out pMode : TD3DDisplayMode) : HResult; stdcall;   //20
    ...
    function ShowCursor(const bShow : BOOL) : BOOL; stdcall;   //30
    ...
    function BeginScene : HResult; stdcall;          //+88
    function EndScene : HResult; stdcall;            //+8C
    ...
    function SetViewport(var pViewport : TD3DViewport8) : HResult; stdcall;       //+A0
    ...
    function SetLight(const Index : LongWord; var pLight : TD3DLight8) : HResult; stdcall;  //+B0
    ...
    function SetClipPlane(const Index : LongWord; pPlane : PSingle) : HResult; stdcall;        //+c0
    ...
    function BeginStateBlock : HResult; stdcall;                                                    //+D0
    ...
    function DeleteStateBlock(const Token : LongWord) : HResult; stdcall;                               //E0
    ...
    function GetTexture(const Stage : LongWord; out ppTexture : IDirect3DBaseTexture8) : HResult; stdcall;  //F0
    ...
    function ValidateDevice(out pNumPasses : LongWord) : HResult; stdcall;                 //100
    ...
    function SetCurrentTexturePalette(const PaletteNumber : Cardinal) : HResult; stdcall;       //110
...
//  function CreateVertexShader(pDeclaration, pFunction : PLongWord; var pHandle : LongWord; const Usage : LongWord) : HResult; stdcall;
    ...
    function SetVertexShader(const Handle : LongWord) : HResult; stdcall;          //130
