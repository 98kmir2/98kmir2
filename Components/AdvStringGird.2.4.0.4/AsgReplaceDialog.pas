  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          {$IFDEF DELPHI4_LVL}
          FGrid.Cells[FGridCell.X,FGridCell.Y] := StringReplace(FGrid.Cells[FGridCell.X,FGridCell.Y],TextToFind.Text,TextToReplace.Text,[rfReplaceAll]);
          {$ELSE}
          FGrid.Cells[FGridCell.X,FGridCell.Y] := StringReplace(FGrid.Cells[FGridCell.X,FGridCell.Y],TextToFind.Text,TextToReplace.Text,'$amp');
          {$ENDIF}
        end;
