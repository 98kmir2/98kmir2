...
begin
  ...
  begin
    ...
    if (sIPaddr = '') or (Str_ToInt(sPort, 0) = 0) then
    begin
      Beep;
      Exit;
    end;
  ...
  while (true) do
  begin
    if Config.GateRoute[nGateIdx].sTitle = sTitle then
    begin
      nRouteIdx := nGateIdx;
      Break;
    end;
