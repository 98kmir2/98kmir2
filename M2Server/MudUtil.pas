...
type
  ...
  TConfig = record
    ...
    nHealthFillTime_HUMAN_WARRIOR: Integer;
    nHealthFillBasic_HUMAN_WARRIOR: Integer; //回血基数
    nSpellFillTime_HUMAN_WARRIOR: Integer;
    nSpellFillBasic_HUMAN_WARRIOR: Integer; //回蓝基数

    nHealthFillTime_HUMAN_WIZARD: Integer;
    nHealthFillBasic_HUMAN_WIZARD: Integer; //回血基数
    nSpellFillTime_HUMAN_WIZARD: Integer;
    nSpellFillBasic_HUMAN_WIZARD: Integer; //回蓝基数

    nHealthFillTime_HUMAN_TAOIST: Integer;
    nHealthFillBasic_HUMAN_TAOIST: Integer; //回血基数
    nSpellFillTime_HUMAN_TAOIST: Integer;
    nSpellFillBasic_HUMAN_TAOIST: Integer; //回蓝基数

    nHealthFillTime_HERO_WARRIOR: Integer;
    nHealthFillBasic_HERO_WARRIOR: Integer; //回血基数
    nSpellFillTime_HERO_WARRIOR: Integer;
    nSpellFillBasic_HERO_WARRIOR: Integer; //回蓝基数

    nHealthFillTime_HERO_WIZARD: Integer;
    nHealthFillBasic_HERO_WIZARD: Integer; //回血基数
    nSpellFillTime_HERO_WIZARD: Integer;
    nSpellFillBasic_HERO_WIZARD: Integer; //回蓝基数

    nHealthFillTime_HERO_TAOIST: Integer;
    nHealthFillBasic_HERO_TAOIST: Integer; //回血基数
    nSpellFillTime_HERO_TAOIST: Integer;
    nSpellFillBasic_HERO_TAOIST: Integer; //回蓝基数

    nHealthFillTime_MON: Integer;
    nHealthFillBasic_MON: Integer; //回血基数
    nSpellFillTime_MON: Integer;
    nSpellFillBasic_MON: Integer; //回蓝基数

    nHealthDecBasic: Integer; //人物移动时掉HP点数
    nHealthDecTime: Integer; //人物移动时掉HP时间间隔
...
{$IFEND}
    ...
    GroupExpHumRate: array[0..GROUPMAX - 2] of LongWord;
    ...
    boJointStrikeUI: Boolean;  
    boOpenFindPathMyMap: Boolean;  
    ...
    fMagicDeadEyeRedPosion: Boolean;     
    fMagicDeadEyeGreenPosion: Boolean;   
