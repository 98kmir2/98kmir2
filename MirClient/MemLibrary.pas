...
type
  ...
  pfnDllMain = function(dwHandle, dwReason, dwReserved: DWord): DWord; stdcall;

function memLoadLibrary(pLib: Pointer; var dllentry: pfnDllMain): DWord;
...
begin
  ...
  else {no PChar, calculate the ordinal directly}
